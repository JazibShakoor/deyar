...
const Card = ({ imageSrc, title, price, onClick,cardData }) => {
  return (
    <div onClick={onClick} className="w-[350px] h-[400px] hover:scale-105 ease-in duration-200 mx-auto bg-white rounded-xl shadow-md overflow-hidden dark:bg-slate-700">
