  ...
  return (
    <div id="deals" className="relative p-4 mb-4">
      <div className="flex justify-center items-center  p-3">
        <button className="mt-[90px] mb-4 bg-blue-600 text-white hover:bg-blue-600 px-4 py-1 rounded-2xl  hover:text-white h-8 w-28 font-black text-xs uppercase cursor-pointer ">
          Projects
        </button>
      </div>
      <div className="relative ">
        <div className="flex flex-col justify-center items-center">
          <p className=" text-[68px]  md:text-6xl mt-12 lg:text-10xl text-blue-700 opacity-5 font-black text-center z-0 absolute top-0 left-0 w-full uppercase dark:text-white">
         Projects
          </p>
          <p className="text-4xl text-blue-900 font-bold text-center z-20 relative capitalize mt-20 sm:mt-28 dark:text-gray-300">
            our best Projects for today
          </p>
        </div>
      </div>
